...
<head>
	...
	<title>Student Hostel attendence management</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Attendence </h2>
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="left">Hostel attendence</h3>
				<?php }
				else{
							echo "";
							}			
...
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Attendence Related info </h4> </label>
</div>
...
<option value="">Select Duration in Month for total attendence</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">Total marked attendence</label>
<div class="col-sm-8">

<input type="text" name="ta" id="ta"  class="result form-control"  68>
</div>
</div>
