...
function markAttendance($studentId)
{
    ...
    if ($result->num_rows > 0) {
        ...
        // Mark attendance
        $query = "INSERT INTO attendance (student_id, date) VALUES ('$studentId', '$date')";
...
// Example usage
$studentId = $_POST['student_id']; // Assuming you have a form with 'student_id' field
...
<head>
    <title>Hostel Attendance Management System</title>
</head>
<head>
	<meta charset="UTF-8">
